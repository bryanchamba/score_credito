...
function doSearch(tbl){
    const tableReg = document.getElementById(tbl);
...
function urlS(str){let t = "./"+str+".ctl.php";return t;}
function playSound(f){
    let sonido = new Audio(f);
    sonido.play();
}
const CRONO = {
    control: null,
    ...
    Centesimas: null,
    inicio: function () {
        this.Hora = document.getElementById('crono').children[0];
        this.Minutos = document.getElementById('crono').children[1];
        this.Segundos = document.getElementById('crono').children[2];
        this.Centesimas = document.getElementById('crono').children[3];
        ...
        this.Centesimas.innerHTML = ":00";

        this.control = setInterval(() => {
            if (this.cente < 99) {
                this.cente++;
                if (this.cente < 10) { this.cente = "0"+this.cente }
                this.Centesimas.innerHTML = ":"+this.cente;
            }
            if (this.cente == 99) {
                this.cente = -1;
            }
            if (this.cente == 0) {
                this.segun ++;
                if (this.segun < 10) { this.segun = "0"+this.segun }
                this.Segundos.innerHTML = ":"+this.segun;
            }
            if (this.segun == 59) {
                this.segun = -1;
            }
            if ( (this.cente == 0)&&(this.segun == 0) ) {
                this.minut++;
                if (this.minut < 10) { this.minut = "0"+this.minut }
                this.Minutos.innerHTML = ":"+this.minut;
            }
            if (this.minut == 59) {
                this.minut = -1;
            }
            if ( (this.cente == 0)&&(this.segun == 0)&&(this.minut == 0) ) {
                this.hors ++;
                if (this.hors < 10) { this.hors = "0"+this.hors }
                this.Horas.innerHTML = hors;
            }
        }, 10);
    },
    parar: function () {
...
function urlGF(str,p=""){p = "?"+p;let t = "components/"+str+".php"+p;return t;}