...
?>
	...
	<head>
		...
		<title>MENU CONFIGURACIONES</title>
	...
	<body>
		<ul id="slide-out" class="sidenav sidenav-fixed blue-grey darken-2">
			...
			<li><a href="#!" class="white-text" onclick="item('control_empresa');"><i class="material-icons grey-text">apartment</i>Empresa</a></li>
			<li><a href="#!" class="white-text" onclick="item('control_agencias');"><i class="material-icons cyan-text">apartment</i>Agencias</a></li>
			<li><a href="#!" class="white-text" onclick="item('control_indicadores');"><i class="material-icons red-text">closed_caption</i>Indicadores</a></li>
			<li><a href="#!" class="white-text" onclick="item('control_ponderacion');"><i class="material-icons teal-text">assessment</i>Ponderación</a></li>
			<!-- <li class="no-padding">
				<ul class="collapsible collapsible-accordion">
					<li>
						<a class="collapsible-header white-text">Talento Humano<i class="material-icons white-text">arrow_drop_down</i></a>
						<div class="collapsible-body">
							<ul>
								<li><a href="#!" onclick="item('v2_form_la_r_cargos_1');"><i class="material-icons indigo-text">crisis_alert</i>Cálculo Riesgo</a></li>
								<li><a href="#!" onclick="item('control_cargos');"><i class="material-icons cyan-text">category</i>Cargos</a></li>
								<li><a href="#!" onclick="item('v2_grid_la_colores');"><i class="material-icons lime-text">palette</i>Colores</a></li>
							</ul>
						</div>
					</li>
				</ul>
