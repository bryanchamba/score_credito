...
if(isset($_SESSION['g_usuario'])){ 
    ...
    <table>
        <tbody>
            <tr>
                <td><b>NOMBRE</b></td>
                <td><?php echo $datper[0][1]; ?></td>
                <td><b>DIRECCIÓN DOMICILIO</b></td>
                <td><?php echo $datper[0][2]; ?></td>
                <td><b>SECTOR</b></td>
                <td><?php echo $datper[0][3]; ?></td>
            </tr>
            <tr>
                <td><b>EDAD</b></td>
    ...
    if($a_1 != false){
        foreach ($a_1 as $a1) { ?>
            ...
            <?php if($a1[2] == 't'){ ?>
                ...
                <?php $cappag = [[0,0],null];
                if($datper[0][24] == 1){
                    $cappag[1] = $db->sCapPago($age,$cod,$datper[0][24],1);
                    $cappag[0][0] = ($cappag[1][0][1] == '+' ? $cappag[0][0]+$cappag[1][0][2] : $cappag[0][0]-$cappag[1][0][2]);
                    $cappag[0][0] = ($cappag[1][1][1] == '+' ? $cappag[0][0]+$cappag[1][1][2] : $cappag[0][0]-$cappag[1][1][2]);
                    
                    $cappag[0][1] = ($cappag[1][2][1] == '+' ? $cappag[0][1]+$cappag[1][2][2] : $cappag[0][1]-$cappag[1][2][2]);
                    $cappag[0][1] = ($cappag[1][3][1] == '+' ? $cappag[0][1]+$cappag[1][3][2] : $cappag[0][1]-$cappag[1][3][2]);
                    $saldo = $cappag[0][0]-$cappag[0][1];
                }else if($datper[0][24] == 2){
                    $cappag[1] = $db->sCapPago($age,$cod,$datper[0][24],1);
                    $cappag[0][0] = ($cappag[1][0][1] == '+' ? $cappag[0][0]+$cappag[1][0][2] : $cappag[0][0]-$cappag[1][0][2]);
                    $cappag[0][0] = ($cappag[1][1][1] == '+' ? $cappag[0][0]+$cappag[1][1][2] : $cappag[0][0]-$cappag[1][1][2]);
                    ...
                    $cappag[0][1] = ($cappag[1][2][1] == '+' ? $cappag[0][1]+$cappag[1][2][2] : $cappag[0][1]-$cappag[1][2][2]);
                    $cappag[0][1] = ($cappag[1][3][1] == '+' ? $cappag[0][1]+$cappag[1][3][2] : $cappag[0][1]-$cappag[1][3][2]);
                    $cappag[0][1] = ($cappag[1][4][1] == '+' ? $cappag[0][1]+$cappag[1][4][2] : $cappag[0][1]-$cappag[1][4][2]);
                    $saldo = $cappag[0][0]-$cappag[0][1];
                }else{
                    $saldo = -100000;
                } ?>
