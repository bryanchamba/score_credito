    ...
    <div id="auxParam">
        ...
        <div class="row">
            <div class="col s12 center">
                <button class="btn blue" onclick="uSolicitud();">ACTUALIZAR<i class="right material-icons white-text">update</i></button>
                <div class="right">
        ...
        <div class="card-panel">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m2">
                    <input id="npt_fecha" type="date" value="<?php echo $s[0][4]; ?>">
