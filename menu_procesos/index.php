...
?>
	...
	<body>
		<ul id="slide-out" class="sidenav sidenav-fixed blue-grey darken-2">
			...
			<li><a href="#!" class="white-text" onclick="item('control_solicitud');"><i class="material-icons teal-text">account_balance_wallet</i>Solicitud</a></li>
			<li><a href="#!" class="white-text" onclick="item('control_clientes');"><i class="material-icons blue-text">group</i>Clientes</a></li>
			<br><br><br>
		</ul>
		<main id="main"></main>
